...
<H3>Any enhancements to any part of the original source code, that you decide to make public for others, should be submited back to Mr. Randy Rogers at the GitHub https://github.com/Devuna website, by whichever mechanism that he has defined.</H3>
