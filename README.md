...
<br/>
<H3>Do not forget to register these templates at the location that they are. If your RED file is set up correctly they will be picked up when you re-start the IDE.</H3>
 </br></br>
