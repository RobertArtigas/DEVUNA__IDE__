...
SaveResults            FUNCTION(FindStrOptionsGroupType FindStrOptions, *CSTRING szSendToFilename),BOOL   !
     END
     MODULE('KSS015.CLW')
CheckRegistration      FUNCTION(*CSTRING szRegistrant, *LONG ExpiryDate),LONG   !
RegisterProduct        FUNCTION(),LONG   !
     END
     MODULE('KSS016.CLW')
...
glo:OpenClarionFilesInIDE LONG
glo:ClarionExePath   STRING(255)
